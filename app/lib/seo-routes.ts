...
export const SEO_ROUTE_SLUGS = [
  ...
  // Routes with real user demand from GA4 internal search data (2026-06-13)
  'salem-to-thuraiyur',
  'musiri-to-thuraiyur',
  'koyambedu-to-vellore',
  'arakkonam-to-poonamallee',
  'sathyamangalam-to-mysore',
  'tambaram-to-arani',
  'vellore-to-cheyyar',
  'rajapalayam-to-thoothukudi',
  'rasipuram-to-erode',
  'walajahpet-to-chennai',
  'rajapalayam-to-aruppukkottai',
  'pudukkottai-to-palani',
  'pudukkottai-to-coimbatore',
  'erode-to-vellakovil',
  'chidambaram-to-chennai-madhavaram',
  'palani-to-erode',
  'namakkal-to-thuraiyur',
  'mannargudi-to-pattukkottai',
  'tirunelveli-to-sivakasi',
  'tiruchengode-to-salem',
  'tirunelveli-to-udangudi',
] as const;
